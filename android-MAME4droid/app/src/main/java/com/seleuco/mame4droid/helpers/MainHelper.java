...
public class MainHelper {
    ...
    public void updateMAME4droid() {
        ...
        if (this.getscrOrientation() == Configuration.ORIENTATION_PORTRAIT) {
            ...
            // On Android TV / with a gamepad (e.g. Xbox) attached the on-screen
            // touch controls must disappear so the 16:9 screen stays clean.
            if (state == TouchController.STATE_SHOWING_NONE
    ...
    public void detectDevice() {
		...
		if(quest) {
            ...
            if (!prefs.getBoolean("androidtv", false)) {
                ...
                // No on-screen touch controls on a TV — navigate with the gamepad / remote.
                edit.putBoolean(PrefsHelper.PREF_LANDSCAPE_TOUCH_CONTROLLER,
                        false);
                // Auto-hide any touch controls the moment a gamepad (e.g. Xbox) is plugged in.
                edit.putBoolean(PrefsHelper.PREF_HIDE_ON_PAD, true);
                // Hide the virtual stick overlay too.
                edit.putBoolean(PrefsHelper.PREF_HIDE_STICK, true);
                edit.putBoolean(PrefsHelper.PREF_BITMAP_FILTERING,
                        true);
