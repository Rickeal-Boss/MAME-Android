...
public class PrefsHelper implements OnSharedPreferenceChangeListener {
	...
	final static public String PREF_HIDE_ON_PAD = "PREF_HIDE_ON_PAD";
	...
	/**
	 * When true (default), the on-screen touch controls are automatically hidden
	 * while a physical gamepad (e.g. Xbox) is connected. This is the expected
	 * behaviour on Android TV where the screen should stay clean.
	 */
